...
| 56 | Android 回归、APK 与 Windows IPC 合并顺序 | 未开始 | 先完成上述 Android 自动化测试、版本升级和新版 APK/Gitea Release；随后才将 Windows IPC PR 的 source 幂等与 owner/target 校验修复合并到主分支。 |
...
- [ ] 构建、校验并发布 v0.3.4 APK；记录 SHA-256、versionCode、versionName、测试命令和结果。
