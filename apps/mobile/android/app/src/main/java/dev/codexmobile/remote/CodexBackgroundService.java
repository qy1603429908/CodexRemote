...
public class CodexBackgroundService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        persistState(title, text, threadId, openAction, true);
    ...
    static void start(Context context, String title, String text, String threadId, String openAction) {
        Intent intent = command(context, ACTION_START, title, text, threadId, openAction);
        ContextCompat.startForegroundService(context, intent);
    }

    static void update(Context context, String title, String text, String threadId, String openAction) {
        Intent intent = command(context, ACTION_UPDATE, title, text, threadId, openAction);
        ContextCompat.startForegroundService(context, intent);
    }
    ...
    private void persistState(String title, String text, String threadId, String openAction, boolean running) {
    ...
    private static final class ServiceState {
        ...
        ServiceState(String title, String text, String threadId, String openAction) {
            this.title = title;
            this.text = text;
